...
use pocketmine\level\particle\CriticalParticle as PMCriticalParticle;
use pocketmine\Server;

class CriticalsParticle implements BaseParticle {
    ...
    public static function onSpawn(Player $player) : void {
        ...
        $player->getLevel()->addParticle(new PMCriticalParticle(($player->asVector3()->add(0, 0.3))), $players);
    }
