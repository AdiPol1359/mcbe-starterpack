...
use pocketmine\level\particle\FlameParticle as PMFlameParticle;
use pocketmine\Server;

class FlameParticle implements BaseParticle {
    ...
    public static function getInventoryItem() : Item {
        return Item::get(Item::BLAZE_POWDER);
    }
    ...
    public static function onSpawn(Player $player) : void {
        ...
        $player->getLevel()->addParticle(new PMFlameParticle($player->asPosition()), $players);
    }
