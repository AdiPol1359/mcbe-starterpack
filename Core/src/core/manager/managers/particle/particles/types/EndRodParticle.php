...
use core\manager\managers\particle\particles\custom\EndRod;
...
class EndRodParticle implements BaseParticle {
    ...
    public static function onSpawn(Player $player) : void {
        ...
        $player->getLevel()->addParticle(new EndRod(Position::fromObject($player->asPosition()->add(0, 0.3))), $players);
    }
