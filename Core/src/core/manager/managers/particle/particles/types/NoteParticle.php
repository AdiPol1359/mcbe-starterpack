...
use core\manager\managers\particle\particles\custom\Note;
use pocketmine\Server;

class NoteParticle implements BaseParticle {
    ...
    public static function onSpawn(Player $player) : void {
        ...
        $player->getLevel()->addParticle(new Note($player->asPosition()), $players);
    }
