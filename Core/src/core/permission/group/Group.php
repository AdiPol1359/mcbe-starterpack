...
class Group {
    ...
    public function setData(array $data) : void {
        $cfg = Main::getGroupManager()->getConfig();
    ...
    public function getPermissions() : array {
        ...
        foreach($this->data['parents'] as $groupName)
            foreach(Main::getGroupManager()->getGroup($groupName)->getPermissions() as $perm)
                $perms[] = $perm;
    ...
    public function updatePlayersPermissions() : void {
        foreach($this->getPlayers() as $nick)
            Main::getGroupManager()->getPlayer($nick)->updatePermissions();
    ...
    public function getParents() : array {
        ...
        foreach($this->data['parents'] as $groupName)
            $parentGroups[] = Main::getGroupManager()->getGroup($groupName);
    ...
    public function delete() : void {
        ...
        foreach($this->getPlayers() as $nick)
            Main::getGroupManager()->getPlayer($nick)->removeGroup($this);
    }
    ...
    public function reload() : void {
        $this->data = Main::getGroupManager()->getGroup($this->getName())->getData();
    }
}