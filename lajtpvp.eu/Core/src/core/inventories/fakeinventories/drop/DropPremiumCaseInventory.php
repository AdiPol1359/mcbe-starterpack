...
class DropPremiumCaseInventory extends FakeInventory {

    public function __construct() {
        parent::__construct("§l§eDROP Z PREMIUMCASE", FakeInventorySize::LARGE_CHEST);
    }
    ...
    public function setItems() : void{
        ...
        foreach(Settings::$PREMIUMCASE_DROP as $key => $data) {
            if($place >= 45)
                return;
