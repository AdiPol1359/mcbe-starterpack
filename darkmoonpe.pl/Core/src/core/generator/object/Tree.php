...
namespace core\generator\object;

use core\generator\object\tree\{
    BirchTree,
    JungleTree,
    OakTree,
    SpruceTree
...
abstract class Tree {
    ...
    public int $type = 0;
    public int $trunkBlock = Block::LOG;
    public int $leafBlock = Block::LEAVES;
    ...
    public function placeObject(ChunkManager $level, int $x, int $y, int $z, Random $random) {
        ...
        $this->placeTrunk($level, $x, $y, $z, $this->treeHeight - 1);
    ...
    protected function placeTrunk(ChunkManager $level, int $x, int $y, int $z, int $trunkHeight) {
