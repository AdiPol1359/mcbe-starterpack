...
use core\manager\managers\particle\particles\custom\Campfire;
use pocketmine\Server;

class CampfireParticle implements BaseParticle {
    ...
    public static function onSpawn(Player $player) : void {
        ...
        $player->getLevel()->addParticle(new Campfire($player->asPosition()), $players);
    }
