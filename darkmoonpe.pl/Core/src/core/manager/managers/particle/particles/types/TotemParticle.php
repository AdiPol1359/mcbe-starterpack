...
use core\manager\managers\particle\particles\custom\Totem;
...
class TotemParticle implements BaseParticle {
    ...
    public static function onSpawn(Player $player) : void {
        ...
        $player->getLevel()->addParticle(new Totem($player->asPosition()), $players);
    }
