...
use pocketmine\level\particle\HeartParticle as PMHeartParticle;
use pocketmine\Server;

class HeartParticle implements BaseParticle {
    ...
    public static function onSpawn(Player $player) : void {
        ...
        $player->getLevel()->addParticle(new PMHeartParticle($player->asPosition()), $players);
    }
