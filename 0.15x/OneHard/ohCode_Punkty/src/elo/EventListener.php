             ...
             if($cause instanceof EntityDamageByEntityEvent and $cause->getDamager() instanceof Player){
              $killername = $cause->getDamager()->getName();
				 switch(mt_rand(1, 14)){
					 ...
					 Server::getInstance()->broadcastMessage("§8• §7Gracz  §6" . $ev->getPlayer()->getName() . " §8[§4-" . $eloloss . "§8] §7zostal zabity przez  §6" . $killername . " §8[§a+" . $elo . "§8]§7! §8•");
					 $cause->getDamager()->getPlayer()->sendPopup("§7Zabiles §6" . $ev->getPlayer()->getName() . " §8[§a+" . $elo . "§8]\n\n\n\n\n\n\n");
					 break;
					 					 case 2:
					 $eloloss = 27;
					 $elo = 38;
