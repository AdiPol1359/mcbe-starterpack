			...
			if(strtolower($command->getName('f'))) {
				...
				if(count($args == 2)) {
					...
					if($args[0] == "create" || $args[0] == "zaloz") {
						if(!isset($args[1]) && !isset($args[2])) {
							$sender->sendMessage($this->plugin->formatMessage("Uzyj: &3/zaloz [tag] [nazwa]"));
							return true;
						}
						if(!(strlen($args[2] <= 16))){
						$sender->sendMessage($this->plugin->formatMessage("&c&lBlad: &7Tag gildi musi zawierac 2-5 znakow, nazwa 4-32 znakow"));						
						}
						if(isset($args[1]) && !isset($args[2])){
						...
						if(strlen($args[1]) > $this->plugin->prefs->get("MaxFactionNameLength")) {
							$sender->sendMessage($this->plugin->formatMessage("Ten tag jest zbyt dlugi! Maksymalna ilosc liter w tagu to 5"));
							return true;
						}
						if(isset($args[1]) && isset($args[2])){
							if($sender->getInventory()->contains(Item::get(57, 0, 64)) or $sender->hasPermission("gildie.darmowe")){
							if($sender->getInventory()->contains(Item::get(41, 0, 64)) or $sender->hasPermission("gildie.darmowe")){
							if($sender->getInventory()->contains(Item::get(46, 0, 64)) or $sender->hasPermission("gildie.darmowe")){
							if($sender->getInventory()->contains(Item::get(49, 0, 64)) or $sender->hasPermission("gildie.darmowe")){
							if($sender->getInventory()->contains(Item::get(466, 0, 10)) or $sender->hasPermission("gildie.darmowe")){
							if($sender->getInventory()->contains(Item::get(145, 0, 16)) or $sender->hasPermission("gildie.darmowe")){
							if($sender->getInventory()->contains(Item::get(340, 0, 64)) or $sender->hasPermission("gildie.darmowe")){
						if($this->plugin->isInFaction($sender->getName())) {
							...
							$factionName = $args[1];                                                    
                                                        ...
                                                        if($sender->getY() > 10) {
                                                            $sender->sendMessage($this->plugin->formatMessage("Jestes zbyt wysoko! Gildie mozesz zalozyc do Y: 10."));
                                                            return true;
                                                        }
                                                        ...
                                                        Server::getInstance()->broadcastMessage("§2§lGILDIE §8* §6Gracz §7" . $sender->getName() . " §6zalozyl gildie §8[§2" . $args[2] . "§8] §7" . $factionName . "", true);                                                                                                            
							...
							if($this->plugin->prefs->get("FactionNametags")) {
                                                        ...
                                                        $sender->getInventory()->removeItem(Item::get(57, 0, 64));
                                                        $sender->getInventory()->removeItem(Item::get(46, 0, 64));
                                                        $sender->getInventory()->removeItem(Item::get(49, 0, 64));                        
                                                        $sender->getInventory()->removeItem(Item::get(340, 0, 64)); 
														$sender->getInventory()->removeItem(Item::get(145, 0, 16));
														$sender->getInventory()->removeItem(Item::get(466, 0, 10));
                           ...
                           /*$level->setBlock(new Vector3($x, $y, $z), Block::get(50, 0));       
							...
							$sender->sendMessage($this->plugin->formatMessage("Brakuje Ci 64 ksiazek!"));	
							}
							}
														else{
							$sender->sendMessage($this->plugin->formatMessage("Brakuje Ci 16 kowadel!"));	
							}
							}
														else{
							$sender->sendMessage($this->plugin->formatMessage("Brakuje Ci 64 obsydianu!"));	
							}
							}
														else{
							...
							$sender->sendMessage($this->plugin->formatMessage("Brakuje Ci 32 jablka!"));	
							}
							}
							else{
					...
					if($args[0] == "leader" || $args[0] == "lider") {
						...
						if(!$this->plugin->getServer()->getPlayerExact($args[1]) instanceof Player) {
							...
							Server::getInstance()->broadcastMessage("§8• §7Gracz§3 " . $args[1] . " §7został nowym liderem gildi§3 " . $factionName . "§7! §8•", true);
							if($this->plugin->prefs->get("FactionNametags")) {
					...
					if($args[0] == "kick" || $args[0] == "wyrzuc") {
						...
						$factionName = $this->plugin->getPlayerFaction($player);
						Server::getInstance()->broadcastMessage("§8• §7Gracz§3 " . $args[1] . " §7został wyrzucony z§3 " . $factionName . "§7! §8•", true);
				...
				if(count($args == 1)) {
					...
					/*if(strtolower($args[0] == "claim" || $args[0] == "teren")) {
						...
						$sender->sendMessage($this->plugin->formatMessage("Teren gildii zostal zabezpieczony.", true));
                                        }
					...
					if(strtolower($args[0] == "unclaim" || $args[0] == "usunteren")) {
						...
						$sender->sendMessage($this->plugin->formatMessage("Teren gildii zostal odbezpieczony.", true));
					}*/
					...
					/*if(strtolower($args[0] == "motd" || $args[0] == "motto")) {
						...
						$sender->sendMessage($this->plugin->formatMessage("Wprowadz motto gildii na czacie.", true));
					...
					if(strtolower($args[0] == "accept" || $args[0] == "akceptuj" || $args[0] == "dolacz")) {
						...
						if($sender->getInventory()->contains(Item::get(264, 0, 10))){
							...
							if($this->plugin->getServer()->getPlayer($array["invitedby"])) {
								if($this->plugin->getServer()->getPlayer($array["invitedby"])) {
									Server::getInstance()->broadcastMessage("§8• §7Gracz§3 " . $sender->getName() . " §7dołaczył do gildi§3 " . $faction . "§7! §8•", true);
								}
							}
							if($this->plugin->prefs->get("FactionNametags")) {
					...
					if(strtolower($args[0] == "del" || $args[0] == "usun")) {
						if($this->plugin->isInFaction($player) == true) {
							if($this->plugin->isLeader($player)) {
								Server::getInstance()->broadcastMessage("§8• §7Gildia§3 " . $this->plugin->getPlayerFaction($sender->getName()) . " §7została rozwiązana przez§3 " . $sender->getName() . "§7! §8•", true);
					...
					/////////////////////////////// LEAVE ///////////////////////////////
 					...
 					if(strtolower($args[0] == "opusc") or strtolower($args[0] == "leave")) {
						if($this->plugin->isLeader($sender->getName()) == false) {
							...
							$name = $sender->getName();
							if($this->plugin->isInFaction($sender->getName())) {
							Server::getInstance()->broadcastMessage("§8• §7Gracz§3 " . $sender->getName() . " §7opuścil gildie§3 " . $faction ."§7! §8•", true);
...
+							$sender->getPlayer()->teleport(new Position($array['x'], $array['y'], $array['z'], $world));
                    ...
                    if (strtolower($args[0] == 'autor')) {
                        $sender->sendMessage(TextFormat::GREEN . "§8[§7===========§8[§4Gildie§8]§7===========§8]");
                        $sender->sendMessage(TextFormat::GREEN . "§4Edytowane FactionsPro przez §3Lexon");
                        $sender->sendMessage(TextFormat::GREEN . "§4dla SV4U.PL");
                        $sender->sendMessage(TextFormat::GREEN . "§8[§7===========§8[§4Gildie§8]§7===========§8]");
                    }
                                        if(strtolower($args[0] == "top" || $args[0] == "ranking")) {
                                            $this->plugin->getFactionTop();
                                            $sender->sendMessage(str_replace('&', '§', "&8[ &7=========== &8[ &4&lRANKING GILDII&r &8] &7=========== &8]"));                
                                            for($i=1; $i<11; $i++) {
					...
					if($args[0] == 'itemy') {
						$sender->sendMessage("-------------------------");
						$sender->sendMessage("Itemy na gildie");
						$sender->sendMessage("-------------------------");
						$sender->sendMessage("64 bloki zlota");
						$sender->sendMessage("64 bloki diamentow");
						$sender->sendMessage("64 tnt");
						$sender->sendMessage("64 obsidian");
						$sender->sendMessage("64 ksiazka ");
						$sender->sendMessage("64 kowadla");
						$sender->sendMessage("10 kox jablka");
						$sender->sendMessage("�8�3-------------------------");
					}
				...
				/////////////////////////////// SILA 1 ///////////////////////////////
					if(strtolower($args[0] == "efekt") && strtolower($args[1] == "1")){
						if($sender->getInventory()->contains(Item::get(388, 0, 32))){
							...
							$this->plugin->getServer()->getPlayer($row["player"])->addEffect($efekt);
                   ...
                   /////////////////////////////// SPRAWDZ ///////////////////////////////
					...
					if(strtolower($args[0]) == 'sprawdz'){
                        ...
                        if(!$this->plugin->isInPlot($x, $z)){
                            $sender->sendMessage($this->plugin->formatMessage("§7Ten teren jest wolny! Mozesz zalozyc tutaj gildie!", true));
							return true;
                        }
                        $sender->sendMessage($this->plugin->formatMessage("§7Ten teren jest zajęty przez gildie:§3 $fac"));
										...
										if(strtolower($args[0]) == "members" || strtolower($args[0]) == "czlonkow" || strtolower($args[0]) == "lista" || strtolower($args[0]) == "list") {
                                            ...
                                            $sender->sendMessage($this->plugin->formatMessage("Liczba czlonkow (Wszystkich: " . $members["all"]. ", Online: " . $members["online"] . "): " . $members["players"] . TextFormat::GRAY . ".", true));
                                            return true;
                                        }
										}
										/////////////////////////////// POWIEKSZANIE TERENU ///////////////////////////////
