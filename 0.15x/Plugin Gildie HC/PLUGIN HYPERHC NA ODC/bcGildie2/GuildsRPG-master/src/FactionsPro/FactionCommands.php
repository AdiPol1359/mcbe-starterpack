                ...
                if (count($args == 2)) {
                    ...
                    if ($args[0] == "zaloz") {
                        ...
                        if ($this->plugin->isInFaction($sender->getName())) {
							...
							if($sender->getInventory()->contains(Item::get(41, 0, 10))){
						    if($sender->getInventory()->contains(Item::get(42, 0, 10))){
							if($sender->getInventory()->contains(Item::get(116, 0, 5))){
						    if($sender->getInventory()->contains(Item::get(322, 0, 16))){
						    if($sender->getInventory()->contains(Item::get(133, 0, 10))){
							if($sender->getInventory()->contains(Item::get(57, 0, 10))){
							if($sender->getInventory()->contains(Item::get(145, 0, 10))){
							$sender->getInventory()->removeItem(Item::get(41, 0, 10));
							$sender->getInventory()->removeItem(Item::get(42, 0, 10));
							$sender->getInventory()->removeItem(Item::get(116, 0, 5));
							$sender->getInventory()->removeItem(Item::get(322, 0, 16));
							$sender->getInventory()->removeItem(Item::get(133, 0, 10));
							$sender->getInventory()->removeItem(Item::get(57, 0, 10));
							$sender->getInventory()->removeItem(Item::get(145, 0, 5));
							$factionName = $args[1];
							...
							return true;
								...
								$sender->sendMessage($this->plugin->formatMessage("§7 • =====[§aIty]§7===== • "));
								$sender->sendMessage($this->plugin->formatMessage("§a • (10) Bloków diamentów §a• "));
								$sender->sendMessage($this->plugin->formatMessage("§a • (16) Refili §a• "));
								$sender->sendMessage($this->plugin->formatMessage("§a • (10) Bloków żelaza §a• "));
								$sender->sendMessage($this->plugin->formatMessage("§a • (5) Enchantów§a• "));
								$sender->sendMessage($this->plugin->formatMessage("§a • (10) Bloków złota §a• "));
								$sender->sendMessage($this->plugin->formatMessage("§a • (10) Bloków emeraldów §a• "));
								$sender->sendMessage($this->plugin->formatMessage("§6 • (5) Kowadeł §a• "));
						   }
						}
						else{
								$sender->sendMessage($this->plugin->formatMessage("§7 • =====[§aIty§7]===== • "));
								$sender->sendMessage($this->plugin->formatMessage("§a • (10) Bloków diamentów  • "));
								$sender->sendMessage($this->plugin->formatMessage("§a • (16) Refili • "));
								$sender->sendMessage($this->plugin->formatMessage("§a • (10) Bloków żelaza • "));
								$sender->sendMessage($this->plugin->formatMessage("§a • (5) Enchantów§a • "));
								$sender->sendMessage($this->plugin->formatMessage("§a • (10) Bloków złota • "));
								$sender->sendMessage($this->plugin->formatMessage("§a • (10) Bloków emeraldów • "));
								$sender->sendMessage($this->plugin->formatMessage("§a • (5) Kowadeł • "));						
						   }
						}
						else{
								$sender->sendMessage($this->plugin->formatMessage("§7 • =====[§aIty§7]===== • "));
								...
								$sender->sendMessage($this->plugin->formatMessage("§a • (16) Refili • "));
								$sender->sendMessage($this->plugin->formatMessage("§a • (10) Bloków żelaza • "));
								$sender->sendMessage($this->plugin->formatMessage("§a • (5) Enchantów • "));
								$sender->sendMessage($this->plugin->formatMessage("§a • (10) Bloków złota • "));
								$sender->sendMessage($this->plugin->formatMessage("§a • (10) Bloków emeraldów • "));
								$sender->sendMessage($this->plugin->formatMessage("§a • (5) Kowadeł • "));									
						   }
                    ...
                    if ($args[0] == "dodaj") {
                        ...
                        $result = $stmt->execute();
                        $sender->sendMessage($this->plugin->formatMessage("$invitedName został zaproszony do gildi", true));
                   ...
                   if ($args[0] == "wyrzuc") {
                        if (!isset($args[1])) {
                            $sender->sendMessage($this->plugin->formatMessage("Usage: /g wyrzuc <gracz>"));
                            return true;
                        }
                        if ($this->plugin->isInFaction($sender->getName()) == false) {
                        ...
                        if ($kicked instanceof Player) {
                            $kicked->sendMessage($this->plugin->formatMessage("Zostałeś wyrzucony z $factionName", true));
                            $this->plugin->updateTag($this->plugin->getServer()->getPlayerExact($args[1])->getName());
                            return true;
                        }
                    }
...
/*Help Commands*/
                    ...
                    if (strtolower($args[0]) == 'top') {
						...
						$sender->sendMessage("§8[§7---------- §8[§aTOP GILDIE§8]§7 ----------§8]");
                    }
					...
					/////////////////////////////// OPUSUN OPUSUNTEREN ///////////////////////////////
					                    if(strtolower($args[0] == "opusunteren")){
                        if(!isset($args[1])){
                            $sender->sendMessage($this->plugin->formatMessage("Użyj: /g opusunteren"));
                            return true;
                        }
                        if(!$this->plugin->factionExists($args[1])) {
					...
					/////////////////////////////// CZAT ////////////////////////////////
                        ...
                        for ($i = 0; $resultArr = $result->fetchArray(SQLITE3_ASSOC); $i = $i + 1) {
                            ...
                            if ($p instanceof Player) {
                                $p->sendMessage("§f• §8[§a" . $rank . "§8]§7 $player:§a" . $message . "§f•");
                    ...
                    if (strtolower($args[0] == "sojusz")) {
                        ...
                        $stmt->bindValue(":timestamp", time());
                        $result = $stmt->execute();
                        $sender->sendMessage($this->plugin->formatMessage("§7Wysłano prośbe o sojusz do gildi $args[1]! Poczekaj na odpowiedz...", true));
                        $leader->sendMessage($this->plugin->formatMessage("§7Lider gidli $fac wysyła prośbe o sojusz. Wpisz /g sojuszakceptuj aby zaakceptować lub /g sojsuzodrzuc aby odrzucic...", true));
                    }
                   ...
                   /////////////////////////////// SPRAWDZ ///////////////////////////////
                    ...
                    if (strtolower($args[0] == 'autor')) {
                        ...
                        $sender->sendMessage(TextFormat::GREEN . "§aGildie by XManta 1337");
                        $sender->sendMessage(TextFormat::GREEN . "§a Błendy zglos na kanale XManta 1337");
                        $sender->sendMessage(TextFormat::GREEN . "§8[§7===========§8[§aGildie§8]§7===========§8]");
                    }
