...
class YtCommand extends CoreCommand {
	...
	public function execute(CommandSender $sender, string $label, array $args) : void {
	    if(!$this->canUse($sender))
		  ...
		  $sender->sendMessage(" \n§8          §4§lPolishHard§7.EU\n§r");
				...
				$sender->sendMessage("   §7Musisz posiadac §l§4250§r §7subow oraz §l§4trailer§r §7na kanale");
				$sender->sendMessage("   §7Twoje filmy musza posiadac srednio §l§470§r §7wyswietlen");
				$sender->sendMessage(" §7Permisje Rangi §l§4YT§r§7:");
				$sender->sendMessage(" §8- §7/kit yt");
				$sender->sendMessage(" §8- §7/repair");
				$sender->sendMessage(" §8- §7-15% Itemow na gildie");
