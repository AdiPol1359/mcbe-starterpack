	...
	public function onCommand(CommandSender $sender, Command $command, String $label, array $args) : bool{
        ...
        public function getFactionTop() {
            ...
            while($row = $faction->fetchArray(SQLITE3_BOTH)) {
                $this->getTop[11]++;
                $this->getTop[$this->getTop[11]] = "&7Gildia &e" . strtoupper($row[0]) . "&7 (Punkty &e$row[1]&7)";
            }
        }
...
public function newPlot($faction, $x1, $z1, $x2, $z2) {
	...
	public function formatMessage($string, $confirm = false) {
		if($confirm) {
			return TextFormat::WHITE . "§f• " . TextFormat::YELLOW . "§8[§aGildie§8] " . TextFormat::GRAY . "$string " . TextFormat::WHITE . "•";
		} else {	
			return TextFormat::WHITE . "§f• " . TextFormat::YELLOW . "§8[§aGildie§8] " . TextFormat::GRAY . "$string " . TextFormat::WHITE . "•";
		}
	}
